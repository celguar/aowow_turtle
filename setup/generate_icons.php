...
*/
  ...
  function resave($outfilename, $img, $width, $height)
  {
    ...
    if (substr($outfilename, -4) == ".png")
      imagepng($imgnew, $outfilename);
  ...
  function process($dbcfile, $dbcfmt)
  {
    ...
    foreach ($dbc as $row)
    {
      ...
      else
      {
        ...
        $stat_dst = @stat($largedir . $dstfilename . ".png");
        ...
        else
        {
          ...
          resave($largedir . $dstfilename . ".png", $img, 56, 56);
          resave($mediumdir . $dstfilename . ".png", $img, 36, 36);
          resave($smalldir . $dstfilename . ".png", $img, 18, 18);
...
//          echo "    $file\n";
  ...
  process("ItemDisplayInfo.dbc", "nxxxxsxxxxxxxxxxxxxxxxx");
