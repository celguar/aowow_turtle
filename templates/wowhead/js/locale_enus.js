var mn_items = [
    ...
    [4, "Armor", ,
        [
            ...
            [6, "Shields", "?items=4.6.14"],
            [7, "Librams", "?items=4.7.28"],
            [8, "Idols", "?items=4.8.28"],
            [9, "Totems", "?items=4.9.28"],
            [0, "Miscellaneous", , [
                [2, "Amulets", "?items=4.0.2"],
                [16, "Cloaks","?items=4.1.16"],
                [11, "Rings", "?items=4.0.11"],
                [12, "Trinkets", "?items=4.0.12"],
                [23, "Off-hand Frills", "?items=4.0.23"],
                [4, "Shirts", "?items=4.0.4"],
                [19, "Tabards", "?items=4.0.19"],
            ]
            ],
        ], , "INV_Chest_Plate16"
    ],
    ...
    [12, "Quest", , , , "INV_Misc_Bone_OrcSkull_01"],
    [13, "Keys", , , , "INV_Misc_Key_04"],
    [-500, 'Turtle WoW Items', , , , "ability_hunter_pet_turtle"]
];
...
var mn_quests = [
    [0, "Eastern Kingdoms", ,
        [
            [36, "Alterac Mountains"], [45, "Arathi Highlands"], [3, "Badlands"],
            [25, "Blackrock Mountain"], [4, "Blasted Lands"], [46, "Burning Steppes"],
            [41, "Deadwind Pass"], [2257, "Deeprun Tram"], [1, "Dun Morogh"], [10, "Duskwood"],
            [139, "Eastern Plaguelands"], [12, "Elwynn Forest"], [267, "Hillsbrad Foothills"],
    ...
    [1, "Kalimdor", ,
        [
            [331, "Ashenvale"], [16, "Azshara"],
            [148, "Darkshore"], [1657, "Darnassus"], [405, "Desolace"], [14, "Durotar"], [15, "Dustwallow Marsh"],
    ...
    [2, "Dungeons", ,
        [
            [719, "Blackfathom Deeps"], [1584, "Blackrock Depths"],
    ...
    [4, "Classes", ,
        [
            [-263, "Druid"], [-261, "Hunter"], [-161, "Mage"], [-141, "Paladin"], [-262, "Priest"], [-162, "Rogue"], [-82, "Shaman"], [-61, "Warlock"], [-81, "Warrior"]
        ]
    ],
    [5, "Professions", ,
        [
...
var mn_database = [
    ...
    [2, "Item Sets", "?itemsets"],
    [4, "NPCs", "?npcs", mn_npcs],
    [5, "Objects", "?objects", mn_objects],
    [3, "Quests", "?quests", mn_quests],
    [1, "Spells", "?spells", mn_spells], /*[6, "Zones", "?zones", mn_zones],*/
    [7, "Factions", "?factions"]//,
    // [, "Utilities"],
    // [30, "Latest Comments", "?latest=comments"] /*, [31, "Latest Screenshots", "?latest=screenshots"] */
];
var mn_tools = [[0, "Maps", "?maps"]]; //[0, "Talent Calculator", "?talent", mn_talentCalc],  not working yet
var mn_path = [[0, "Database", , mn_database], [1, "Tools", , mn_tools]];
// var mn_path = [[0, "Database", , mn_database]];
var g_chr_classes = {
    11: "Druid",
    3: "Hunter",
    8: "Mage",
...
var LANG = {
    ...
    types: {
        ...
        9: ["Talent", "talent", "Talents", "talents"]
    },
